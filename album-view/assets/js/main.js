...
var main = (function($) { var _ = {
			...
			_.$thumbnails.children()
				.each(function() {
					...
					// Slide.
						...
						// Create elements.
	 						s.$slide = $('<div class="slide"><div class="caption1"></div><div class="image"></div></div>');
	...
	auto: function() {
		intv = this.setTimer();
		_.$navNext.on('mouseover', function() {
			clearInterval(intv)
			intv = _.setTimer()
		});
		_.$navPrevious.on('mouseover', function() {
			clearInterval(intv)
			intv = _.setTimer()
		});
		_.$thumbnails.on('mouseover', '.thumbnail', function() {
			clearInterval(intv)
			intv = _.setTimer()
		});
	},

}; return _; })(jQuery); main.init(); main.auto();